...
export const fetchAgentRN: AgentFunction<
  { debug?: boolean; type?: string; throwError?: boolean },
  any,
  any
...
const fetchAgentRNInfo: AgentFunctionInfo = {
  name: "fetchAgent",
  agent: fetchAgentRN,
  mock: fetchAgentRN,
  inputs: {
...
export default fetchAgentRNInfo;
